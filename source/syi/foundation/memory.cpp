...
#if defined (syi_MEMORY_STACK)
class syiStackWalker : public StackWalker {
public:
    syiStackWalker() : StackWalker() {}
protected:
    virtual void OnOutput( LPCSTR szText ) {
        rprint( "\nStack: \n%s\n", szText );
        StackWalker::OnOutput( szText );
    }
}; // class syiStackWalker
